...
<legend style="align:center; font-size:26px; font-weight:bold; margin-left:10%;"> Update Employee details</legend>
    
<table align="center" cellpadding="10">

 <tr>
 <td>Employee Name:</td>
 <td><input type="text"  value="<?php echo "$en"  ?>" placeholder=" Employee Name" name="name" required></td>
 </tr>
 
 <tr>
<td>Employee ID:</td>
 <td><input type="text"  value="<?php echo "$rn"  ?>" placeholder=" Employee ID" name="ID" required></td>
 </tr>

<tr>
<td>Employee Age:</td>
 <td><input type="text"  value="<?php echo "$ag"  ?>" placeholder=" Employee Age"   name="Age" required></td>
 </tr>
...
if($_GET[submit])
{
	...
	$ad=$_GET['Address'];
	$phone=$_GET['no'];
$query="UPDATE Employee SET Employee_name='$name',Employee_Id='$ID',Age='$Age',Gender='$gender',Address='$ad',Phone_number='$phone' WHERE Employee_Id='$ID'";
...
if($data)
{
	...
	header("Location:e_update_fail.php");
